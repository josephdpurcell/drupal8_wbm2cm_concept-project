  ...
  public static function createRequiredFiles(Event $event) {
    ...
    if (!$fs->exists($root . '/sites/default/settings.php')) {
      if (!$fs->exists($root . '/sites/default/default.settings.php')) {
        $fs->copy($root . '/sites/default/example.settings.php', $root . '/sites/default/settings.php');
      }
      else {
    ...
    if (!$fs->exists($root . '/sites/default/services.yml')) {
      if (!$fs->exists($root . '/sites/default/default.services.yml')) {
        $fs->copy($root . '/sites/default/example.services.yml', $root . '/sites/default/services.yml');
      }
      else {
